...
namespace TLab.Android.WebView
{
	public class TLabWebView : MonoBehaviour
	{
		...
		public int WebWidth { get => m_webWidth; set{ m_webWidth = value;}}
		public int WebHeight { get => m_webHeight; set{ m_webHeight = value;}}
		...
		private Coroutine m_webvieReStartTask;
